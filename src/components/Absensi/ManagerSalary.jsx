...
const ManagerSalary = ({ user }) => {
    ...
    const generatePdf = () => {
        ...
        doc.save(`Manager_Salary_Slip_${user.name}_${new Date().getMonth() + 1}_${new Date().getFullYear()}.pdf`);
    };
