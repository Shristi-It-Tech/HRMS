...
const EmployeeProfile = ({ user, employees, setEmployees, setAuthUser, pendingProfileChanges, setPendingProfileChanges }) => {
    ...
    const handleRequestProfileUpdate = (changes) => {
        ...
        showSwal(
            'Request Submitted',
            'Your profile changes require Manager approval. Status: Pending.',
            'success'
        );
        setIsEditing(false);
    };
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mt-6">
            <div className="flex justify-between items-center mb-6 pb-4 border-b border-gray-100">
                <h2 className="text-xl font-semibold text-gray-800 flex items-center">
                    <i className="fas fa-user-circle mr-3 text-[#708993]"></i> Employee Profile
                </h2>
            ...
            {pendingRequest && (
                <div className="p-4 mb-6 bg-amber-50 border border-amber-200 rounded-lg flex items-start">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-amber-700 mt-1">Awaiting Manager Approval</p>
                    </div>
                </div>
            )}
                    ...
                    <div className="text-center w-full">
                        ...
                        <div className="space-y-3 w-full max-w-xs">
                            ...
                            <div className="bg-green-50 rounded-lg p-3 text-center border border-green-100">
                                ...
                                <p className="text-green-700 font-bold text-lg">{user.leaveBalance} days</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <textarea
                                    ...
                                    placeholder="Example: Main Street No. 123, Central Jakarta, DKI Jakarta"
                                />
                            </div>
